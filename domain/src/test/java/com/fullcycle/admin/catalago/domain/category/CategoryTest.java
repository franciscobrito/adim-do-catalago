...
public class CategoryTest {
    ...
    public void givenAnInvalidNameLengthLessThan3_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        final var expectedName = """
                Caros amigos, a valorização de fatores subjetivos exige a precisão e a definição das 
                condições inegavelmente apropriadas. Não obstante, o desenvolvimento contínuo de distintas
                formas de atuação pode nos levar a considerar a reestruturação formas de atuação pode nos levar a 
                considerar a reestruturação formas de atuação pode nos levar a considerar a reestruturação
                formas de atuação pode nos levar a considerar a reestruturação
                """;
        final var expectedErrorCount = 1;
        final var expectedErrorMessage = "'name' should not be between 3 and 255 characters";
        final var expectedDescription = "A categoria mais assistida";
